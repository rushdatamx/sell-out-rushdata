...
const tiendasMap = {
  ...
  '2160': 86 // Este estaba en el mapeo anterior
};
...
// Generar CSV
let csv = 'tenant_id,retailer_id,tienda_id,producto_id,fecha,unidades_inventario\n';
inventario.forEach(i => {
  csv += `${i.tenant_id},${i.retailer_id},${i.tienda_id},${i.producto_id},${i.fecha},${i.unidades_inventario}\n`;
});
