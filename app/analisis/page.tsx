...
import {
  useAnalisisKpisYoY,
  useAnalisisVentasMensualesYoY,
  useAnalisisProductosYoY,
  useAnalisisTiendasYoY,
  useAnalisisEstacionalidadSemanal,
  useAnalisisCiudadesYoY,
...
export default function AnalisisPage() {
  ...
  // Opciones para filtro de ciudades (hardcoded por ahora, idealmente vendría de un endpoint)
  const ciudadOptions: FilterOption[] = [
  ...
  return (
    <div className="flex-1 space-y-6 p-6 premium-bg gradient-overlay min-h-screen">
      ...
      <div className="sticky-header-blur flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Análisis Comparativo</h1>
